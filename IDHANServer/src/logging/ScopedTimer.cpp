...
ScopedTimer::ScopedTimer( const std::string& str, const std::chrono::milliseconds ms_warn_time ) :
  name( str ),
...
ScopedTimer::~ScopedTimer()
{
	...
	if ( duration > m_warn_time ) log::warn( "{} took {}s {}ms", name, duration_s, duration_ms % 1000 );
}
} // namespace idhan::logging
