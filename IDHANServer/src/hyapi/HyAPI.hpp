...
#define HYAPI_AUTH_FILTERS HyAPIAuthName
  ...
  public:
	...
	ADD_METHOD_TO(
		HydrusAPI::sessionKey,
		"/hyapi/session_key",
		drogon::Get,
		HYAPI_AUTH_FILTERS,
		RESPONSE_ENRICHER_NAME );
	ADD_METHOD_TO(
		HydrusAPI::verifyAccessKey,
		"/hyapi/verify_access_key",
		drogon::Get,
		HYAPI_AUTH_FILTERS,
		RESPONSE_ENRICHER_NAME );
	ADD_METHOD_TO(
		HydrusAPI::getService,
		"/hyapi/get_service",
		drogon::Get,
		HYAPI_AUTH_FILTERS,
		RESPONSE_ENRICHER_NAME );
	...
	ADD_METHOD_TO(
		...
		RESPONSE_ENRICHER_NAME );
	ADD_METHOD_TO(
		HydrusAPI::fileHashes,
		"/hyapi/get_files/file_hashes",
		drogon::Get,
		HYAPI_AUTH_FILTERS,
		RESPONSE_ENRICHER_NAME );
	ADD_METHOD_TO(
		HydrusAPI::fileMetadata,
		"/hyapi/get_files/file_metadata",
		drogon::Get,
		HYAPI_AUTH_FILTERS,
		RESPONSE_ENRICHER_NAME );
	ADD_METHOD_TO( HydrusAPI::file, "/hyapi/get_files/file", drogon::Get, HYAPI_AUTH_FILTERS, RESPONSE_ENRICHER_NAME );
	ADD_METHOD_TO(
		HydrusAPI::thumbnail,
		"/hyapi/get_files/thumbnail",
		drogon::Get,
		HYAPI_AUTH_FILTERS,
		RESPONSE_ENRICHER_NAME );
	ADD_METHOD_TO(
	...
	ADD_METHOD_TO(
		...
		RESPONSE_ENRICHER_NAME );
	ADD_METHOD_TO(
		HydrusAPI::getUrlInfo,
		"/hyapi/add_urls/get_url_info",
		drogon::Get,
		HYAPI_AUTH_FILTERS,
		RESPONSE_ENRICHER_NAME );
	...
	ADD_METHOD_TO(
		HydrusAPI::getPopups,
		"/hyapi/manage_popups/get_popups",
		drogon::Get,
		HYAPI_AUTH_FILTERS,
		RESPONSE_ENRICHER_NAME );
