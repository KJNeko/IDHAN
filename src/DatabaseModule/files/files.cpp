...
// Filepath from only hash
	...
	{
		ZoneScoped;
		return internal::generatePathToFile( "paths/thumbnail_path", "./db/thumbnails", 't', sha256 ).string() + ".jpg";
	}
	...
	{
		ZoneScoped;
		return internal::generatePathToFile( "paths/file_path", "./db/file_paths", 'f', sha256 );
	}
}