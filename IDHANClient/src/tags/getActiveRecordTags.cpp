...
QFuture< std::vector< TagID > > IDHANClient::getActiveRecordTags( RecordID record_id, TagDomainID tag_domain_id )
{
	const auto path { format_ns::format( "/records/{}/tags/active", record_id ) };
